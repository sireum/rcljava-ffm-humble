...
public class rmw_publisher_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rmw_publisher_options_s.layout().withName("options"),
        gen_h.C_BOOL.withName("can_loan_messages"),
        MemoryLayout.paddingLayout(7)
    ).withName("rmw_publisher_s");
    ...
    private static final long can_loan_messages$OFFSET = 40;
