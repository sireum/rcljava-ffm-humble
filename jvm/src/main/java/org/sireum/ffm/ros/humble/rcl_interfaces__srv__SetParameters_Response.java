 ...
 * }
 */
public class rcl_interfaces__srv__SetParameters_Response {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rcl_interfaces__msg__SetParametersResult__Sequence.layout().withName("results")
    ).withName("rcl_interfaces__srv__SetParameters_Response");
