 ...
 * }
 */
public class rcl_interfaces__srv__SetParameters_Request {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rcl_interfaces__msg__Parameter__Sequence.layout().withName("parameters")
    ).withName("rcl_interfaces__srv__SetParameters_Request");
    ...
    private static final long parameters$OFFSET = 0;
