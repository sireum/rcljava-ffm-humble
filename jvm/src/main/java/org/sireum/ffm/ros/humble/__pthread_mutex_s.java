...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gen_h.C_INT.withName("__lock"),
        gen_h.C_INT.withName("__count"),
        gen_h.C_INT.withName("__owner"),
        gen_h.C_INT.withName("__nusers"),
        gen_h.C_INT.withName("__kind"),
        gen_h.C_INT.withName("__spins"),
