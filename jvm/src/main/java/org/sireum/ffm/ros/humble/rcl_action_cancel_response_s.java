 ...
 * }
 */
public class rcl_action_cancel_response_s {

    rcl_action_cancel_response_s() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        action_msgs__srv__CancelGoal_Response.layout().withName("msg"),
        rcutils_allocator_s.layout().withName("allocator")
    ).withName("rcl_action_cancel_response_s");
