...
public class _IO_FILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gen_h.C_INT.withName("_flags"),
        MemoryLayout.paddingLayout(4),
        gen_h.C_POINTER.withName("_IO_read_ptr"),
        gen_h.C_POINTER.withName("_IO_read_end"),
        gen_h.C_POINTER.withName("_IO_read_base"),
        gen_h.C_POINTER.withName("_IO_write_base"),
        gen_h.C_POINTER.withName("_IO_write_ptr"),
        gen_h.C_POINTER.withName("_IO_write_end"),
        gen_h.C_POINTER.withName("_IO_buf_base"),
        gen_h.C_POINTER.withName("_IO_buf_end"),
        gen_h.C_POINTER.withName("_IO_save_base"),
        gen_h.C_POINTER.withName("_IO_backup_base"),
        gen_h.C_POINTER.withName("_IO_save_end"),
        gen_h.C_POINTER.withName("_markers"),
        gen_h.C_POINTER.withName("_chain"),
        gen_h.C_INT.withName("_fileno"),
        gen_h.C_INT.withName("_flags2"),
        gen_h.C_LONG.withName("_old_offset"),
        gen_h.C_SHORT.withName("_cur_column"),
        gen_h.C_CHAR.withName("_vtable_offset"),
        MemoryLayout.sequenceLayout(1, gen_h.C_CHAR).withName("_shortbuf"),
        MemoryLayout.paddingLayout(4),
        gen_h.C_POINTER.withName("_lock"),
        gen_h.C_LONG.withName("_offset"),
        gen_h.C_POINTER.withName("_codecvt"),
        gen_h.C_POINTER.withName("_wide_data"),
        gen_h.C_POINTER.withName("_freeres_list"),
        gen_h.C_POINTER.withName("_freeres_buf"),
        gen_h.C_LONG.withName("__pad5"),
        gen_h.C_INT.withName("_mode"),
        MemoryLayout.sequenceLayout(20, gen_h.C_CHAR).withName("_unused2")
    ).withName("_IO_FILE");
