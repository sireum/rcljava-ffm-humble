...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, gen_h.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, gen_h.C_SHORT).withName("__old_x"),
        gen_h.C_SHORT.withName("__c"),
        gen_h.C_SHORT.withName("__init"),
        gen_h.C_LONG_LONG.withName("__a")
