 ...
 * }
 */
public class rcl_action_server_options_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rcl_duration_s.layout().withName("result_timeout")
    ).withName("rcl_action_server_options_s");
    ...
    private static final long cancel_service_qos$OFFSET = 88;
    ...
    private static final long result_service_qos$OFFSET = 176;
    ...
    private static final GroupLayout result_timeout$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("result_timeout"));
     ...
     * }
     */
    public static final GroupLayout result_timeout$layout() {
        return result_timeout$LAYOUT;
    }

    private static final long result_timeout$OFFSET = 480;
     ...
     * }
     */
    public static final long result_timeout$offset() {
        return result_timeout$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment result_timeout(MemorySegment struct) {
        return struct.asSlice(result_timeout$OFFSET, result_timeout$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void result_timeout(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, result_timeout$OFFSET, result_timeout$LAYOUT.byteSize());
    }
