...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, gen_h.C_POINTER).withName("__locales"),
        gen_h.C_POINTER.withName("__ctype_b"),
        gen_h.C_POINTER.withName("__ctype_tolower"),
        gen_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, gen_h.C_POINTER).withName("__names")
