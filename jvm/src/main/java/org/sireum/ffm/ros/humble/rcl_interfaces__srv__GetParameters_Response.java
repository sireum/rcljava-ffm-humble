 ...
 * }
 */
public class rcl_interfaces__srv__GetParameters_Response {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rcl_interfaces__msg__ParameterValue__Sequence.layout().withName("values")
    ).withName("rcl_interfaces__srv__GetParameters_Response");
