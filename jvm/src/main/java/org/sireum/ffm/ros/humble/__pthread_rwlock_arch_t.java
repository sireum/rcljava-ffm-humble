...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gen_h.C_INT.withName("__readers"),
        gen_h.C_INT.withName("__writers"),
        gen_h.C_INT.withName("__wrphase_futex"),
        gen_h.C_INT.withName("__writers_futex"),
        gen_h.C_INT.withName("__pad3"),
        gen_h.C_INT.withName("__pad4"),
        gen_h.C_INT.withName("__cur_writer"),
        gen_h.C_INT.withName("__shared"),
        gen_h.C_LONG.withName("__pad1"),
        gen_h.C_LONG.withName("__pad2"),
        gen_h.C_INT.withName("__flags"),
