 ...
 * }
 */
public class rcl_action_goal_status_array_s {

    rcl_action_goal_status_array_s() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        action_msgs__msg__GoalStatusArray.layout().withName("msg"),
        rcutils_allocator_s.layout().withName("allocator")
    ).withName("rcl_action_goal_status_array_s");
