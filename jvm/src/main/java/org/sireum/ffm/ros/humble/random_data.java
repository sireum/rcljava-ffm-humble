...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gen_h.C_POINTER.withName("fptr"),
        gen_h.C_POINTER.withName("rptr"),
        gen_h.C_POINTER.withName("state"),
        gen_h.C_INT.withName("rand_type"),
        gen_h.C_INT.withName("rand_deg"),
        gen_h.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        gen_h.C_POINTER.withName("end_ptr")
