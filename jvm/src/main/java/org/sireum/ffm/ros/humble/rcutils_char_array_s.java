 ...
 * }
 */
public class rcutils_char_array_s {

    rcutils_char_array_s() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gen_h.C_POINTER.withName("buffer"),
        gen_h.C_BOOL.withName("owns_buffer"),
    ...
    private static final OfBoolean owns_buffer$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("owns_buffer"));
     ...
     * }
     */
    public static final OfBoolean owns_buffer$layout() {
        return owns_buffer$LAYOUT;
    }

    private static final long owns_buffer$OFFSET = 8;
     ...
     * }
     */
    public static final long owns_buffer$offset() {
        return owns_buffer$OFFSET;
    }
     ...
     * }
     */
    public static boolean owns_buffer(MemorySegment struct) {
        return struct.get(owns_buffer$LAYOUT, owns_buffer$OFFSET);
    }
     ...
     * }
     */
    public static void owns_buffer(MemorySegment struct, boolean fieldValue) {
        struct.set(owns_buffer$LAYOUT, owns_buffer$OFFSET, fieldValue);
    }
    ...
    private static final long buffer_length$OFFSET = 16;
    ...
    private static final long buffer_capacity$OFFSET = 24;
