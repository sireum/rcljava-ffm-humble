 ...
 * }
 */
public class rcl_interfaces__srv__DescribeParameters_Response {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rcl_interfaces__msg__ParameterDescriptor__Sequence.layout().withName("descriptors")
    ).withName("rcl_interfaces__srv__DescribeParameters_Response");
    ...
    private static final GroupLayout descriptors$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("descriptors"));
     ...
     * }
     */
    public static final GroupLayout descriptors$layout() {
        return descriptors$LAYOUT;
    }

    private static final long descriptors$OFFSET = 0;
